...
public class OrderController
{
    ...
    @Operation(summary = "Get My orders, in paged format")
    @GetMapping("/user")
    ResponseEntity<Page<OrderDTO>> findMyOrders(@PageableDefault(page = 0, size = 10) Pageable pageable)
    {
        Page<Order> orderPage = orderService.findMyOrders(pageable);
    ...
    ResponseEntity<OrderDTO> updateStatus(@PathVariable Long id, @RequestParam String status) {
